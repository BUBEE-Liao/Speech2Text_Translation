...
class TextAudioCollate():
    ...
    def __call__(self, batch):
        ...
        if self.return_ids: #audio_padded, 
            return audio_feature_padded, audio_feature_mask, src_text_padded, src_text_len, src_text_mask, decoder_input_ids_padded, decoder_input_ids_len, tgt_text_mask, target_ids_padded, target_ids_len, ids_sorted_decreasing
        return audio_feature_padded, audio_feature_mask, src_text_padded, src_text_len, src_text_mask, decoder_input_ids_padded, decoder_input_ids_len, tgt_text_mask, target_ids_padded, target_ids_len